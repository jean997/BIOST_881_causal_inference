...
- I bootstrapped the standard error (code hidden but you can find it [here](https://github.com/jean997/BIOST_881_causal_inference/blob/master/docs/slides_2025/11_time_varying_treatment_pt2.Rmd)).
