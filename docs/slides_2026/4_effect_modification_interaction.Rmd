...
date: "Lecture on 2026-01-29 (updated: `r Sys.Date()`)"
output:
...
- To estimate, $E[Y(1) \vert A = 1]$, we only need consistency and don't need any exchangeability conditions.

- $E[Y(1) \vert A = 1] = E[Y \vert A = 1]$ from consistency. 

---

## Standardization to Estimate the ATT

- For $E[Y(a) \vert A = 1]$, $a \neq 1$, we first use the iterated expectation formula
...
$$
E[Y(a) \vert L = l, A = 1] = E[Y(0) \vert L = l] = E[Y(a) \vert L = l, A = a]
$$
--

- Consistency again:

$$ E[Y(a) \vert L = l, A = a] = E[Y \vert L = l, A = a]$$
--
