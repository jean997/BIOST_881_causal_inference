...
- If we include effect modification or use a nonlinear link, we need to standardize to compute the marginal causal effect. 
...
- $\hat{\Delta}_{S}$, and $\hat{\Delta}_{SR}$ are both asymptotically normal, but the variance is hard to express and depends on the density of the propensity score. 
