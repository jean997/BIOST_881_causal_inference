...
+ Within values of $L$, $P[Y(a) \vert L = l]$ are identified because exchangeability holds within levels of $L$. 
...
+ The target trial: Hernán and Robins suggest that researchers using observational data should imagine a hypothetical 
