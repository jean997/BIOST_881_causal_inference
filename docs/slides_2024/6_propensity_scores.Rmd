...
-  Kang and Schaffer refer to the method we have called G-computation as "OLS".

- In this simulation, G-computation is quite robust to model misspecification.

- GC under the incorrect outome model has lower RMSE than IPW with the correct model.
