...
- Subclassification is a specific version of outcome regression with propensity scores strategy. 

- Idea: Break the data into quantiles based on propensity score and compute the difference of means within each quantile. 
