...
- However, we can't observe $Y_i(A_i = 1, M_i = M_i(0))$ for any units(unless $M_i(0) \neq M_i(1)$). 
...
- Notice that we had to assume these conditions simultaneously for the same set of confounders $L$.
