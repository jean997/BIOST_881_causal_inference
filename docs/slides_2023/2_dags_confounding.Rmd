...
date: "Lecture on 2023-01-09 (updated: `r Sys.Date()`)"
output:
...
1. Connecting DAGs and Counterfactuals through Single World Intervention Graphs
...
+ Work with your neighbor to arrange the following variables in a DAG (there is moer than one right answer):
...
---
# 3. Connecting DAGs and Counterfactuals through Single World Intervention Graphs
