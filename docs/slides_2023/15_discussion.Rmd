...
- To continue the obesity example used by H and T, a common assumption is that the affect of BMI on mortality and on specific diseases is mediated by fat cells or body size. Many people have assumed that the best and only way to intervene is through weight-loss programs. 
...
- Race is another exposure for which there is high risk of allowing readers to fill in causal mechansisms.
