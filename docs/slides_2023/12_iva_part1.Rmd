---
title: "L12: Instrumental Variable Analysis\nPart 1"
author: "Jean Morrison"
institute: "University of Michigan"
date: "Lecture Starting 2023-03-06\n(updated: `r Sys.Date()`)"
output:
...
+ If we have time, we might do some introduction of the last three. 
...
- This means that anyone born in the later three quarters of the year received at least as much education as they would have if they had been born earlier in the year. 
  ...
  + If red-shirting were common, this would violate the monotonicity assumption.
...
- However, if $U_Z$ is not binary, there is no longer a clear definition of what effect we are estimating because it is not clear who the compliers. 

- In this case, the IV estimator estimate a weighted average of the effect of drug A vs drug B. 
